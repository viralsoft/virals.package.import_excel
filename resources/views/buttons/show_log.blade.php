<button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#note_{{ $entry->id }}">Show Logs</button>
<div colspan="3" role="row" id="note_{{ $entry->id }}" class="even collapse" style="color: #fb8080; background: #f9f9f9">
    {!! $entry->note !!}
</div>
<script>
    ...
    newTd_{{ $entry->id }}.setAttribute("colspan", "3");
